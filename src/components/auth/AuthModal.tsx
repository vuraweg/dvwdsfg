...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  useEffect(() => {
    ...
    // ADDED: Skip auto-close logic for forgot-password and success views
    ...
    // Skip auto-close logic if in recovery mode showing reset password
    ...
    // If user is authenticated and profile is incomplete
    if (isAuthenticated && user && user.hasSeenProfilePrompt === false && isOpen) {
      ...
      console.log('AuthModal useEffect: User not authenticated and modal is open. Current view:', currentView);
    }
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {currentView === 'success' && (
            <div className="text-center py-8">
              <div className="bg-green-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 dark:bg-green-900/20">
                <CheckCircle className="w-8 h-8 text-green-600 dark:text-green-400" />
              </div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">All Set!</h2>
              {signupEmail ? (
          ...
          {currentView === 'postSignupPrompt' && (
            <div className="text-center py-8">
              <div className="bg-blue-100 w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-6 dark:bg-neon-cyan-500/20">
                <CheckCircle className="w-10 h-10 text-blue-600 dark:text-neon-cyan-400" />
              </div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">Welcome!</h2>
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  ...
                  className="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-3 px-4 rounded-xl dark:bg-dark-200 dark:hover:bg-dark-300 dark:text-gray-300"
                >
                  Skip for now
                </button>
              </div>
